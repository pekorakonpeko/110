...
proxies:
  - {name: jp_pekopeko_test01, server: pekopeko.store, port: 10001, type: vmess, uuid: 0b312216-6fb4-402b-d0ee-f843c8bc01dc, alterId: 0, cipher: auto, tls: true, network: ws, ws-opts: {path: /konpeko, headers: {Host: pekopeko.store}}}
proxy-groups:
  - name: 🚀 节点选择
    type: select
    proxies:
